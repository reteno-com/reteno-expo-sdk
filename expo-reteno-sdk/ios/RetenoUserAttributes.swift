...
public struct RetenoUserAttributes {
    ...
    private static func buildUserAttributes(userStruct: RetenoUserStruct) -> UserAttributes {
		...
		public static func buildSetUserAttributesPayload(payload: [String: Any]) throws -> RetenoSetUserAttributesPayload {
		...
		public static func buildSetAnonymousUserAttributesPayload(payload: [String: Any]) throws -> AnonymousUserAttributes {
