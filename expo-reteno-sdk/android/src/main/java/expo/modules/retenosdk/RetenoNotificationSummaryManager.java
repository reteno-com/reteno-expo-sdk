...
final class RetenoNotificationSummaryManager {
  ...
  private static final String SUMMARY_TAG_PREFIX = "expo.modules.retenosdk.group-summary:";
  ...
  static void notifyClickListeners(Bundle bundle) {
    NotificationClick.INSTANCE.notifyListeners(bundle != null ? bundle : Bundle.EMPTY);
  }
  ...
  private void enable(String ruleIdentity) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      ...
      // child counts can't be tracked and summaries can't be maintained. This module's minSdk
      // is 24, so this is a defensive no-op rather than a reachable path.
      return;
    }
    enabled = true;
    this.ruleIdentity = ruleIdentity;
  ...
  private void createSummaryChannel() {
    // NotificationChannel does not exist before API 26; this module's minSdk is 24.
